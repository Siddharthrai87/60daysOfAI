<h2>Creating a personal environmental health analyzer</h2>
Prompt used:
...
Do not provide code snippets. Create a complete interactive Claude Artifact with working charts, filters, cards, insights, report cards, and dashboards that users can interact with directly.<br>

What's Inside the Dashboard:

Feature	Details
📊 KPI Cards	Avg AQI · Highest · Lowest · Cities Count · Env. Health Score
📈 5 Chart Tabs	AQI Bar · PM2.5 · PM10 · City Ranking · Radar + Health Scores
🎛 Filters	Region · AQI Range · Pollutant · City Detail Selector
📋 10 City Cards	Click any card to load full health analysis
🩺 Health Panel	Lungs · Sleep · Energy · Exercise · Long-term (air) + Hair/Skin/Scalp (water) with 🔴🟡🟢 risk indicators
🎓 Report Card	Score ring + A–F grades for Air/Water/Hair/Skin with progress bars
💡 Insights Panel	Top 3 cleanest · Top 3 polluted · Anomaly + Executive Summary
💊 Recommendations	6 categories: Daily · Indoor · Outdoor · Hair · Skin · Water
⬇ Export	Downloads a full text report

<img width="906" height="709" alt="image" src="https://github.com/user-attachments/assets/1388ffcc-77f0-4e67-b478-e1bd408ccc8b" />
<img width="855" height="583" alt="image" src="https://github.com/user-attachments/assets/2a821cde-830a-4210-b0d6-40161d4884a4" />
<img width="919" height="669" alt="image" src="https://github.com/user-attachments/assets/6cc42cbd-a246-4bdd-939b-47b4d4b55acd" />
